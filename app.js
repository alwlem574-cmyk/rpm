...
const ROLE_ROUTES = {
  admin: ["*"],
  accountant: ["dashboard","orders","order","customers","customer","vehicles","vehicle","invoices","reports","reportfull","expenses","backup","dedupe","custom","more","auth"],
  reception: ["dashboard","checkin","appointments","orders","order","customers","customer","vehicles","vehicle","invoices","custom","more","auth"],
  technician: ["dashboard","appointments","orders","order","customers","customer","vehicles","vehicle","custom","more","auth"],
